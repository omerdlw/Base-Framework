...
export const AUTH_INPUT_CLASS =
  "h-10 w-full rounded-[20px] bg-white/5 px-4 text-sm text-white placeholder:text-white/50 transition-colors duration-200 hover:bg-white/10 focus:bg-white/10 focus:outline-none";

const PROVIDER_BUTTON_CLASS =
  "group/btn center h-10 w-full cursor-pointer rounded-[20px] bg-white/5 px-4 text-xs @[280px]:text-sm text-white/70 hover:bg-white hover:text-black focus-visible:bg-white focus-visible:text-black disabled:cursor-not-allowed disabled:opacity-50 transition-colors duration-200";

const PROVIDER_GRID_BUTTON_CLASS =
  "group/btn center h-10 w-full cursor-pointer rounded-[20px] bg-white/5 text-white/70 hover:bg-white hover:text-black focus-visible:bg-white focus-visible:text-black disabled:cursor-not-allowed disabled:opacity-50 transition-colors duration-200";
  ...
  return (
    ...
    >
      <span className="flex min-w-0 items-center justify-center gap-2">
        <span className="center size-5 shrink-0 text-white/70 group-hover/btn:text-black group-focus-visible/btn:text-black transition-colors">
...
export function OAuthProviderGridButton({
  ...
  return (
    <Button
      ...
      type="button"
    >
      <span className="center size-5 text-white/70 group-hover/btn:text-black group-focus-visible/btn:text-black transition-colors">
        <Icon icon={config.icon} size={18} />
      </span>
    </Button>
  );
