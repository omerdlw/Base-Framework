export { SEMANTIC_SURFACE_CLASSES } from "@/core/tokens";
...
export const NAV_CARD_LAYOUT = Object.freeze({
  ...
  extensionShelfHeight: NAV_CARD_DIMENSIONS.extensionShelfHeight,
...
export const STATUS_TONES: Record<string, string> = Object.freeze({
  GUARD: "error",
