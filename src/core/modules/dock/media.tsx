...
export const DockSoundwave = memo(function DockSoundwave({
  isPlaying = false,
  className = "",
  barCount = 4,
}: {
    ...
    >
      {Array.from({ length: safeBarCount }).map((_, index) => (
        <motion.span
          key={index}
          custom={index}
          variants={dockSoundwaveBarVariants}
    ...
    >
      <div className="flex items-center gap-1.5">
        <motion.button
          ...
          className={cn(
            "center h-8 cursor-pointer rounded-full px-3 text-xs font-semibold tabular-nums ring-1 ring-inset transition-colors duration-200 select-none focus-visible:outline-none",
            playbackRate !== 1
        ...
        <motion.button
          ...
          className="center size-8 cursor-pointer rounded-full bg-white/5 text-white/70 ring-1 ring-white/5 ring-inset transition-colors duration-200 hover:bg-white/10 hover:text-white hover:ring-white/10 focus-visible:bg-white/10 focus-visible:text-white focus-visible:ring-white/10 focus-visible:outline-none select-none"
      ...
      <div className="flex items-center gap-1.5">
        <motion.div
          ...
          className={cn(
            "group flex h-8 items-center gap-1.5 rounded-full px-2.5 ring-1 transition-colors duration-200 select-none ring-inset",
            isDraggingVolume
        ...
        >
          <Button
            ...
            className="center size-5 cursor-pointer p-0 text-white/70 transition-colors duration-200 hover:text-white"
      ...
      <AnimatePresence>
        {isHovered && showTimeOnHover && duration > 0 && (
          <motion.div
            ...
            className="pointer-events-none absolute top-3 -translate-x-1/2 rounded-[8px] bg-black/80 px-2 py-0.5 text-xs font-medium tabular-nums text-white ring-1 ring-white/10 ring-inset"
