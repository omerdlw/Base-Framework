...
export const FALLBACK_MODAL_STATE: ModalState = Object.freeze({
  activeModalId: null,
...
export const FALLBACK_MODAL_ACTIONS: ModalActions = Object.freeze({
  closeAllModals: () => {},
  closeModal: () => {},
...
export const MODAL_STYLES = Object.freeze({
  CLOSE_BTN:
    "center inline-flex size-8 cursor-pointer rounded-[20px] bg-white/5 text-white/70 ring-1 ring-white/5 ring-inset hover:bg-white hover:text-black hover:ring-transparent focus-visible:ring-2 focus-visible:ring-white/10 focus-visible:outline-none",
