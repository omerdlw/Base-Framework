...
import { useModalRegistry } from "@/core/orchestration";
...
function CloseButton({
  ...
  return (
    ...
    >
      <IconComponent icon="material-symbols:close-rounded" size={16} />
    </ButtonComponent>
  );
}
      ...
      {shouldRenderHeader && (
        <motion.div
          ...
          className={cn(
            ...
            headerConfig?.sticky && "sticky top-0 z-10 bg-black",
          )}
        >
        ...
        <motion.div
          ...
          className={cn(
            hasSlotContent(footerCenter)
              ...
              : "flex justify-between",
            STYLES.HEADER_LAYOUT,
            footerConfig.sticky && "sticky bottom-0 bg-black",
          )}
        >
