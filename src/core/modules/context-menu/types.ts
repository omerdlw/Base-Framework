...
export interface ContextMenuContextApi extends ContextMenuActions {
  menuConfig: ContextMenuConfig | null;
  menuContext: ContextMenuContextValue | null;
  menuItems: ContextMenuResolvedItem[];
  position: ContextMenuPosition;
  isOpen: boolean;
}
...
export interface ContextMenuDefinition {
  id: string;
  use: (options?: Partial<ContextMenuConfig>) => void;
}
