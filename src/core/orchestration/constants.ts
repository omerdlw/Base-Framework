...
export const REGISTRY_RESOLVERS: Record<string, string> = {
  [REGISTRY_TYPES.DOCK]: "merge",
};

export const REGISTRY_DEFINITIONS: Record<string, RegistryDefinition> = {
  ...
  [REGISTRY_TYPES.DOCK]: Object.freeze({
    defaultCleanupDelayMs: 600,
...
export const REGISTRY_FEATURE_KEYS: Set<string> = new Set([
  "background",
  "controls",
  "contextMenu",
  "loading",
...
export const REGISTRY_SINGLETON_KEYS: Record<string, string> = {
  [REGISTRY_TYPES.BACKGROUND]: REGISTRY_KEYS.BACKGROUND,
  [REGISTRY_TYPES.LOADING]: REGISTRY_KEYS.LOADING,
};

export const DOCK_CONFIG_FIELD_TYPES: Readonly<Record<string, string>> =
  Object.freeze({
...
export const DOCK_POLICY_FIELD_TYPES: Readonly<Record<string, string>> =
  Object.freeze({
