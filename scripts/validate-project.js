...
// =============================================================================
// Project Identity Validator (scripts/validate-project.js)
// Validates project identity consistency and ensures zero template leaks.
// =============================================================================
...
if (!fs.existsSync(configPath)) {
  ...
  try {
    ...
    if (isDownstream && config.slug) {
      ...
      // 3. Validate supabase/config.toml
      ...
      // 4. Validate wrangler.jsonc
      const wranglerPath = path.join(rootDir, "wrangler.jsonc");
      if (fs.existsSync(wranglerPath)) {
        const wranglerContent = fs.readFileSync(wranglerPath, "utf8");
        try {
          // Parse loose JSON with comments or regex match
      ...
      // 5. Leak Detection: No legacy template keywords in target files
      const filesToCheck = [
        "package.json",
