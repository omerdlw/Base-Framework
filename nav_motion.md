...
| **`NAV_COMPACT_STACK_ENTER_TRANSITION`**  | Kompakt moda girerken deste konteynerini hızla küçültür               | `<motion.div id="nav-card-stack">`                                          | `Nav` ([index.js](file:///Users/omerdlw/Documents/template/src/modules/nav/index.js))                                                                                                                                        | `compactDirection === "compressing"` veya `isCompactStack`                   | Deste konteynerinin 0.38s APPLE_FLUID ile kompakt boyuta (38px yükseklik) pürüzsüzce daralması                                                                       |
| **`NAV_COMPACT_STACK_EXIT_TRANSITION`**   | Kompakt moddan çıkarken deste konteynerini yeniden genişletir         | `<motion.div id="nav-card-stack">`                                          | `Nav` ([index.js](file:///Users/omerdlw/Documents/template/src/modules/nav/index.js))                                                                                                                                        | `compactDirection === "restoring"`                                           | Deste konteynerinin 0.40s APPLE_FLUID ile normal boyuta (68px+ yükseklik) yavaş açılması                                                                             |
